...
const AgentBubble: React.FC = () => {
  ...
  const send = useCallback(async (q?: string) => {
    ...
    try {
      ...
      const WRITE = ['create_submission', 'propose_edit', 'ingest_project', 'create_slack_report', 'create_scheduled_job', 'add_note', 'resolve_proposal', 'set_contract_address', 'send_telegram', 'log_outreach'];
