...
/*  Mock Data                                                          */
/* ------------------------------------------------------------------ */
const importLogData: ImportLogEntry[] = [
  {
    id: '1',
    date: 'Jun 8, 2026 3:42 PM',
    ...
    duration: '3.2s',
    status: 'Success',
    details: 'Bankr DevRel Intake — Sheet "Submissions"',
  },
  {
    id: '2',
    date: 'Jun 8, 2026 2:15 PM',
    source: 'Google Sheets',
    type: 'Full sync',
    recordsImported: 81,
    newRecords: 3,
    ...
    duration: '8.7s',
    status: 'Success',
    details: 'Bankr DevRel Intake — Complete refresh',
  },
  {
    id: '3',
    ...
    duration: '1.4s',
    status: 'Failed',
    details: 'hackathon_projects.csv — 2 rows failed validation',
  },
  {
    id: '4',
    date: 'Jun 6, 2026 9:00 AM',
    source: 'Google Sheets',
    type: 'Incremental',
    recordsImported: 5,
    newRecords: 5,
  ...
  },
  {
    ...
    duration: '0.8s',
    status: 'Success',
    details: 'devrel_intake.json — Single project import',
  },
];
